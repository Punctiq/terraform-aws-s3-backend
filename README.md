...
| <a name="input_dynamo_tbl_point_in_time_recovery"></a> [dynamo\_tbl\_point\_in\_time\_recovery](#input\_dynamo\_tbl\_point\_in\_time\_recovery) | Enable Point-in-Time Recovery for DynamoDB table | `bool` | `true` | no |
